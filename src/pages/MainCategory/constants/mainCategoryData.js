...
export const mainCategoryBannerMessages = [
  '현재 위치 기반으로 3분 만에 찾는 나만의 완벽한 하루 코스!',
  '동네 한 바퀴 돌듯 가볍게, 주변의 맛집과 카페를 탐색해 보세요',
  '오늘 하루, 어디서 즐겁게 보낼까?',
  '지금 어디세요? 주변 1km 이내의 장소를 바로 불러올게요.',
  '복잡한 검색은 그만, 클릭 몇 번으로 끝내는 하루 코스!',
  'NearByU에서 가장 가까운 곳부터 시작하세요.',
  '오늘 당신의 동선은 여기까지! 반경 설정을 통해 딱 맞는 장소를 골라보세요.',
  '지금 가장 가보고 싶은 곳이 어디인가요? 당신의 선택을 기다리고 있어요.',
];
